<?php namespace xp\codegen\dataset;

use xp\codegen\AbstractGenerator;
use rdbms\DSN;
use rdbms\DBTable;
use rdbms\DriverManager;
use rdbms\util\DBConstraintXmlGenerator;
use rdbms\util\DBXMLNamingContext;
...
class Generator extends AbstractGenerator {
  ...
  static function __static() {
    ...
    self::$adapters['sqlite']= XPClass::forName('rdbms.sqlite3.SQLite3DBAdapter');
